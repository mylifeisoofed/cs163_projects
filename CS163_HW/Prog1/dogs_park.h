...
struct park_node // For every node of dog parks, it will contain (or point) to a list of ammenities!
{
	char * name;
	park_node * next;
	amenity_node * amenity_list; // This is the head pointer to the list of ammenities.
};
...
class DogsParkUnlimited // Class that will be handling the data structure.
{
	public:
		...
		int display_amenities(char park[]); // function to display the list of amenities of that dog park.
